...
public abstract class BaseAppCompatActivity extends AppCompatActivity {
    ...
    /**
     * this Activity of tool bar. * 获取头部. * @return support.v7.widget.Toolbar.
     */
    ...
    /**
     * 是否显示后退按钮,默认显示,可在子类重写该方法. * @return
     */
    ...
    /**
     * this activity layout res * 设置layout布局,在子类重写该方法. * @return res layout xml id
     */
