...
import com.zaki.mymobilesafe.service.AddressService;
import com.zaki.mymobilesafe.service.BlackNumberService;
import com.zaki.mymobilesafe.service.WatchDogService;
...
import com.zaki.mymobilesafe.view.SettingClickView;
...
public class SettingActivity extends BaseAppCompatActivity {
    ...
    private void initAppLock() {
        final SettingItem siv_app_lock = (SettingItem) findViewById(R.id.siv_app_lock);
        boolean isRunning = ServiceUtil.isRunning(this,"com.zaki.mymobilesafe.service.WatchDogService");
    ...
    private void initBlacknumber() {
        final SettingItem siv_blacknumber = (SettingItem) findViewById(R.id.siv_blacknumber);
        boolean isRunning = ServiceUtil.isRunning(this,"com.zaki.mymobilesafe.service.BlackNumberService");
        if (siv_blacknumber != null) {
    ...
    private void initToastStyle() {
        ...
        mToastStyle = SharedPreUtil.getInt(this, ConstantValue.TOAST_STYLE, 0);
    ...
    private void showToastStyleDialog() {
        ...
        builder.setSingleChoiceItems(mToastStyleDes, mToastStyle, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                SharedPreUtil.putInt(getApplicationContext(), ConstantValue.TOAST_STYLE, which);
                dialog.dismiss();
                mToastStyle = SharedPreUtil.getInt(getApplicationContext(),ConstantValue.TOAST_STYLE,0);
    ...
    private void initAddress() {
        final SettingItem siv_address = (SettingItem) findViewById(R.id.siv_address);
        //对服务是否开的状态做显示
        boolean isRunning = ServiceUtil.isRunning(getApplicationContext(), "com.zaki.mymobilesafe.service.AddressService");
