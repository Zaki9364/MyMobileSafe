...
public class SettingActivity extends BaseAppCompatActivity {
    ...
    private void initUpdate() {
        ...
        //获取已有的开关状态,用作显示
        boolean open_update = SharedPreUtil.myGetBoolean(this, ConstantValue.UPDATE_OPEN, false);
        //是否选中,根据上一次存储的结果去做决定
        ...
        siv_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //将取反后的状态存储到相应sp中
                SharedPreUtil.myPutBoolean(getApplicationContext(), ConstantValue.UPDATE_OPEN,!isCheck);
            }
        });
    }
